...
print(torch.equal(
    mha.att_heads[0].query_gen.weight,
    mha.att_heads[1].query_gen.weight
))

print(torch.equal(
    mha.att_heads[0].key_gen.weight,
    mha.att_heads[1].key_gen.weight
))

print(torch.equal(
    mha.att_heads[0].value_gen.weight,
    mha.att_heads[1].value_gen.weight
))'''
